...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO surveys (admin_id, title, description, status) VALUES (?, ?, ?, ?)");
            $stmt->execute([$admin_id, $title, $description, $status]);
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Pilih status survei. Hanya survei aktif yang bisa diisi responden.</small>
                            </div>
