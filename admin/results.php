...
$totalAnswered = array_sum($data); // total jawaban untuk pertanyaan ini (akurat untuk pertanyaan tidak wajib)
?>
<div class="card mb-4">
...
<?php $pct = round(($row['count'] / max($totalAnswered, 1)) * 100, 1); ?>
<tr>
...
style="width: <?php echo $pct; ?>%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"
