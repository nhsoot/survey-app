...
/* === Tombol Aksi: senada dengan surveys.php === */
...
<a href="question_edit.php?survey_id=<?php echo $survey_id; ?>&qid=<?php echo $q['id']; ?>"
   class="btn btn-sm btn-warning btn-aksi" title="Edit Pertanyaan">
    <i class="bi bi-pencil"></i> <span class="label-aksi">Edit</span>
</a>
<a href="?survey_id=<?php echo $survey_id; ?>&delete_q=1&qid=<?php echo $q['id']; ?>"
   class="btn btn-sm btn-danger btn-aksi" title="Hapus Pertanyaan"
